"""
Direct downloader for SP4096 data from kevclark/parameter-golf.

Usage:
    python data/download_sp4096.py --train-shards 1     # smoke test (1 train shard)
    python data/download_sp4096.py --train-shards 143   # full dataset

Files land in:
    data/tokenizers/fineweb_4096_bpe.{model,vocab}
    data/datasets/fineweb10B_sp4096/fineweb_val_000000.bin
    data/datasets/fineweb10B_sp4096/fineweb_train_NNNNNN.bin  (N shards)

Existing files are skipped. SP1024 data is not touched.
"""
...
REPO_DATASET_PREFIX = "datasets/datasets/fineweb10B_sp4096"
REPO_TOKENIZER_PREFIX = "datasets/tokenizers"

ROOT = Path(__file__).resolve().parent
DATASETS_DIR = ROOT / "datasets" / "fineweb10B_sp4096"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Download SP4096 data from kevclark/parameter-golf")
    parser.add_argument(
        "--train-shards",
        type=int,
        default=1,
    ...
    print(f"Downloading SP4096 from {REPO_ID}")
